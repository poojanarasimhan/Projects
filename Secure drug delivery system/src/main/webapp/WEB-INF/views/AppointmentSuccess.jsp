...
<div class="jumbotron"><h2 class="text-center">Hospital Management Systems</h2><h2 class="text-center">ADD DOCTOR</h2></div>
	...
	<p>An appointment has been created for you</p>
	</c:if>
