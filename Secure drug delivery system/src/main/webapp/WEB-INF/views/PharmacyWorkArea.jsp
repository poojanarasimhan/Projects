...
<body>
	<c:if test="${(user.name != null) && (user.type == 'Pharmacy')}">
		...
		<div class="container">
			<div class="row">
				<div class="col-md-4">
					<a href="addToStore.htm"><button type="button"
							class="btn btn-primary">Buy medicines</button></a>
				</div>
				<div class="col-md-4">
					<a href="deliver.htm"><button type="button"
							class="btn btn-primary">Delivery</button></a>
				</div>
			</div>
			<script>
				function formSubmit() {
