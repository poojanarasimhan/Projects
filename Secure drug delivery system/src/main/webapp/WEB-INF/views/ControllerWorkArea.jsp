...
<body>
	...
	<c:if test="${(user.name != null) && (user.type == 'Controller')}">
		...
		<div class="container">
			<div class="row">
				<div class="col-md-4">
					<a href="addPharmacy.htm"><button type="button"
							class="btn btn-primary">ADD PHARMACY</button></a>
				</div>
				<div class="col-md-4">
					<a href="addDoctor.htm"><button type="button"
							class="btn btn-primary">ADD DOCTOR</button></a>
				</div>
				<div class="col-md-4">
					<a href="addMedicine.htm"><button type="button"
							class="btn btn-primary">ADD MEDICINE</button></a>
				</div>
			</div>
		</div>
		<script>
