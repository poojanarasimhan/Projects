 ...
 */
public class CorporateBillingWorkArea extends javax.swing.JPanel {

    /**
     * Creates new form CorporateBillingWorkArea
     */
    ...
    public CorporateBillingWorkArea(JPanel container, UserAccount account, Organization organization, Enterprise enterprise, EcoSystem system) {
        initComponents();
        ...
        for (Organization organization : enterprise.getOrganizationDirectory().getOrganizationList()) {
            if (organization.getName().equals("Customer Organization")) {
                ...
                for (Employee emp : co.getEmployeeDirectory().getEmployeeList()) {
                    ...
                    if (emp.getType().equals("Corporate")) {
                        ...
                        .addGroup(layout.createSequentialGroup()
                            ...
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                    .addComponent(txtZipCode, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 136, Short.MAX_VALUE)
                ...
                if (organization.getName().equals("Customer Organization")) {
                    ...
                    for (Employee emp : co.getEmployeeDirectory().getEmployeeList()) {
                        if (emp.getName().equals(name)) {
                            ...
                            CreateBillJPanel cbjp = new CreateBillJPanel(container, account, organization, enterprise, system, emp);
                            container.add("CreateBillJPanel", cbjp);
