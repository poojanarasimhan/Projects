...
for(Network n : system.getNetworkList()) {
            if(n.getName().equals(String.valueOf(network.getName()))) {
                if(n.getEnterpriseDirectory().getEnterpriseList().size() >= 1) {
                    JOptionPane.showMessageDialog(null, "Multiple Enterprise cannot be created for same network", "FAILURE", JOptionPane.PLAIN_MESSAGE);
                    return;
                }            
            }
        }
for(Network n : system.getNetworkList()){
    for(Enterprise e : n.getEnterpriseDirectory().getEnterpriseList()){
        if(e.getName().equals(name)){
            JOptionPane.showMessageDialog(this, "Enterprise name already exits");
            return;
        }
    }
}
